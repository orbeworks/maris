...
export function createTypeOrmOptions(
  ...
  return {
    ...
    migrations: [CreateChartCatalog2026091700000, ModelEncMetadata2026091800000, CreateEncUploads2026091801000, AddSourceObjectKey2026091802000, AddArtifactObjectKeys2026091803000, AddSourceUrl2026091804000, AddEncObjectKey2026091805000, EnsureObjectStorage2026092000000, DropSourceObjectStorage2026092001000, IncrementalChartShards2026092002000],
    migrationsRun,
    synchronize: false,
  };
}
